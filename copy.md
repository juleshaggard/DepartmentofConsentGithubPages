# Department of Consent: Website Copy
...
**Age restriction:**  
All services and resources are for adults aged 18 and older.

---

# Voice

Department of Consent should sound:
...
- Slightly witty
- Confident without claiming absolute authority
...
- Treating beginners as naive
- Pretending kink is risk-free
- Suggesting there is one correct way to practice kink
- Claims that coaching treats trauma, mental illness, or relationship dysfunction
...
- Explore coaching
- Get the first-event guide
- Ask about event support
...
**Body:**  
Private coaching for understanding your interests, learning the language, evaluating potential partners, negotiating clearly, and preparing for real-world experiences.
...
**Body:**  
Learn what kind of event you are attending, what the rules mean, what to wear, what participation is expected, and how to protect your boundaries.
...
**Body:**  
Clear, beginner-friendly education for partners, small groups, organizations, and community spaces.
...
**Body:**  
Your first kink event should not feel like being dropped into a private club with no explanation.

We can choose an appropriate event, discuss dress and etiquette, review your boundaries, plan how to handle conversations, and make sure you know how to leave whenever you want.

For selected events in the San Francisco Bay Area, nonsexual accompaniment may also be available.

**Clarification:**  
Event accompaniment is educational and social support. It does not include sexual activity, kink play, topping, bottoming, dating, romantic companionship, or guaranteed introductions.
...
**Body:**  
We identify the information, skills, boundaries, and practical preparation most relevant to you.

### Step Three

**Title:**  
Explore with better judgment.

**Body:**  
You leave with specific next steps, useful questions, and a clearer understanding of what you do and do not want.
...
- How to Enter the Kink Scene
- Preparing for Your First Kink Event
- How to Negotiate Your First Scene
...
### Do I need previous kink experience?
...
### Do I need to know exactly what I am into?
...
Understand your interests, learn common terminology, prepare for real-world experiences, and build confidence without pretending to be experienced.
...
Prepare for an event privately or ask about nonsexual event accompaniment.

**CTA:**  
Explore first event support
...
A short conversation to discuss what you need, answer basic questions about coaching, and determine whether the service is appropriate.

**Price:**  
[ADD CURRENT PRICE OR “CONTACT FOR CURRENT PRICING”]

### Private Coaching Session

A focused 60-minute session built around a specific question, decision, or upcoming experience.
...
# Service Page: Kink Coach in San Francisco
...
Private sessions from anywhere, with flexible preparation for events, conversations, relationships, and decisions.

### In-Person Coaching

Selected in-person sessions may be available in San Francisco and parts of the greater Bay Area.

### Event Preparation

A focused session covering the event type, rules, etiquette, boundaries, clothing, participation expectations, and exit plan.

### Nonsexual Event Accompaniment

For selected Bay Area events, Jules may be available to attend as an educational and social guide.
...
Services do not include kink play, topping, bottoming, sexual activity, dating, romantic companionship, physical intimacy, therapy, medical care, or legal advice.

No coach can guarantee that a person, venue, event, or experience is safe. Coaching can help you ask better questions, recognize concerns, and make more deliberate decisions.

## Service Area

**Body:**  
Virtual coaching is available more broadly. In-person availability is limited to San Francisco and selected parts of the greater Bay Area.

[ADD APPROVED SERVICE AREA DETAILS]
...
# Service Page: Beginner BDSM Coaching
...
**Title:**  
Beginner BDSM Coaching | Department of Consent
...
# Guide: Preparing for Your First Kink Event
...
**Title:**  
Preparing for Your First Kink Event | Beginner Guide
...
# Guide: How to Enter the Kink Scene
...
**Title:**  
How to Enter the Kink Scene | Beginner Guide
...
Start with terms that affect the situation you are considering, such as:

- Scene: a planned period of kink activity
- Negotiation: the conversation before activity
- Limit: something a person does not want
- Safeword or signal: a way to pause or stop
- Aftercare: support or attention people may want afterward
- Vetting: gathering information before trusting someone or entering a situation
- Munch: a casual social gathering, usually in ordinary clothes, where kink-interested people meet and talk
...
**Headline:**  
Ready to enter the scene with more context and less guesswork?

**Body:**  
Private coaching can help you choose a first step, prepare for an event, understand an invitation, or think through a potential partner.

**CTA:**  
Explore beginner coaching

---

# Guide: How to Negotiate Your First Scene
...
**Title:**  
How to Negotiate Your First Kink Scene
...
1. What are we considering doing?
2. What does each person want from it?
3. What is off-limits?
4. What health, access, or emotional information matters?
5. How will we communicate intensity?
6. How will we pause or stop?
7. What aftercare does each person want?
8. What would make us decide not to proceed?
9. When will we check in afterward?

## CTA

**Headline:**  
Want help preparing for a specific conversation or first scene?
...
# Service Page: Kink Event Accompaniment
...
**Eyebrow:**  
Nonsexual event support in San Francisco
...
Event accompaniment does not include:
...
In some cases, a private preparation session may be more useful than accompaniment.

## CTA

**Headline:**  
You can ask for a guide without giving up your own judgment.
...
# Guide: Kink Red Flags Beginners Should Know
...
**Headline:**  
Unsure how to evaluate a person, invitation, or upcoming situation?
...
**Body:**  
Beginner-friendly workshops for partners, small groups, organizations, and community spaces.

## Workshop Topics

### Consent Is Only the Beginning

How permission, communication, context, pressure, self-awareness, and the ability to change your mind work together.

### Negotiating Your First Scene

A practical framework for discussing interests, boundaries, health considerations, intensity, stopping, and aftercare.

### Kink Etiquette for Beginners

The unwritten rules of events, observation, introductions, privacy, invitations, and participation.

### Vetting Without Playing Detective

How to gather useful information, identify concerning behavior, ask for references when appropriate, and accept that no process eliminates all risk.

### Opening a Relationship Thoughtfully

A practical discussion of motives, expectations, autonomy, agreements, jealousy, dating, and the possibility that consensual nonmonogamy may not be the right answer.
...
Only include training, certifications, affiliations, years of experience, testimonials, or professional memberships that Jules has explicitly verified.

**Placeholder:**  
[ADD VERIFIED TRAINING, EXPERIENCE, AFFILIATIONS, OR CREDENTIALS]

Do not infer credentials from lived experience.
...
### What is beginner BDSM coaching?
...
### Will you tell me whether someone is safe?
...
### Will Jules attend an event with me?
...
### Does event accompaniment include kink play or sexual activity?
...
[ADD APPROVED CANCELLATION AND REFUND POLICY]

### What does coaching cost?

[ADD CURRENT PRICES OR “CONTACT FOR CURRENT PRICING”]
...
Please do not submit graphic descriptions, medical records, government identification, or a complete sexual history through this form.
...
Information submitted here is used to respond to your inquiry and administer services. Do not use this form for emergencies or reports requiring immediate intervention.
...
Department of Consent provides education, coaching, and practical support related to kink, consent, communication, relationships, consensual nonmonogamy, community participation, and personal decision-making.

Coaching is not psychotherapy, psychiatric treatment, medical care, legal advice, crisis intervention, case management, or a substitute for services provided by a licensed professional.

No outcome, relationship result, event experience, personal safety, or compatibility with another person can be guaranteed.

Kink and sexual activity may involve physical, emotional, interpersonal, legal, privacy, and reputational risks. Education and preparation may reduce uncertainty but cannot remove all risk.
...
Event accompaniment is nonsexual educational and social support. It does not include kink play, sexual activity, topping, bottoming, dating, romantic companionship, physical intimacy, security services, medical supervision, or guaranteed access to an event.

This page must be reviewed by a qualified attorney before public launch.
...
- Event accompaniment limitations
- Prohibited conduct
...
Do not present draft legal language as attorney-approved.
...
- Contact method
- Whether sensitive information should be submitted
- California privacy considerations where applicable

Do not claim HIPAA compliance unless verified.

Do not claim data is encrypted, anonymous, never shared, or permanently deleted unless the implementation confirms it.

Mark the policy as requiring legal review before launch.
...
1. Kink-curious is a feeling. Kink-confident is a skill.
2. You have wondered long enough. Now learn how to do it well.
3. Ready to make kink real? Start with confidence, not chaos.
4. Your fantasies deserve better than trial and error.
5. Stop wondering whether you are doing kink wrong.

## You Do Not Have to Figure This Out Alone

1. You do not have to fake experience to belong here.
2. Everyone looks confident until you ask about their first time.
3. New to kink does not have to mean alone.
4. Your first step into kink can come with someone in your corner.
5. You can be brave and still ask for a guide.

## Kink Has an Instruction Manual

1. Kink has rules. Nobody hands them to you.
2. Learn the scene before the scene teaches you the hard way.
3. You researched the toys. Did you research the people?
4. The most important kink skills happen before anyone gets touched.
5. Confidence starts long before your first scene.

## Consent Is Only the Beginning

1. Consent is the floor, not the finish line.
2. A yes can still lead to a bad experience.
3. Good kink takes more than permission.
4. Consent gets you started. Judgment helps you decide what comes next.
5. The best scenes begin before anyone says yes.

---

# Missing Information Requiring Jules’s Approval
...
- Payment provider
- Testimonials
- Whether public workshops are scheduled
- Legal review of terms, privacy policy, disclaimer, waivers, coaching agreement, and event accompaniment agreement
