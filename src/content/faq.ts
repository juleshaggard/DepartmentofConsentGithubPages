/** Full FAQ content — editorial source of truth is copy.md. */

export type FaqEntry = { question: string; answer: string };

export const FULL_FAQ: FaqEntry[] = [
  {
    question: "What is kink coaching?",
    answer:
  ...
  {
    question: "What is beginner BDSM coaching?",
    answer:
  ...
  {
    question: "What happens during an introductory consultation?",
    answer:
  ...
  {
    question: "Will you tell me whether someone is safe?",
    answer:
  ...
  {
    question: "Will Jules attend an event with me?",
    answer:
  ...
  {
    question: "Does event accompaniment include kink play or sexual activity?",
    answer:
  ...
  {
    question: "Do you offer emergency or crisis support?",
    answer:
