...
function BottomNav() {
  ...
  return (
    <nav className="bottom-nav fixed bottom-4 left-4 right-4 z-40 mx-auto max-w-md rounded-full border border-coral/10 bg-card/95 shadow-[0_14px_45px_oklch(0.22_0.04_20_/_0.14)] backdrop-blur-sm">
