...
export const Route = createFileRoute("/scene-negotiator/")({
  head: () => ({
    meta: [
      { title: "Scene Negotiator — Plan Kink Scenes Together" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Scene Negotiator — Plan Kink Scenes Together" },
      {
...
function Index() {
  ...
  const startTo = hasProfile ? "/scene-negotiator/sessions/new" : "/scene-negotiator/onboarding";
  ...
  return (
    <Layout fullBleed>
      ...
      <header className="w-full px-5 sm:px-10 pt-6 sm:pt-8 pb-2 flex items-center justify-between max-w-6xl mx-auto">
        ...
        <CloudButton to="/scene-negotiator/sessions" variant="outline" className="cloud-btn-sm">
          Get started
        </CloudButton>
      </header>
