...
Marketing site for Department of Consent — beginner-focused kink
coaching by Jules — plus **Scene Negotiator**, the original consent /
...
| `VITE_BOOKING_URL`                                                                                                                                                                       | External scheduler. Empty -> inquiry form only                                                                             |
| `VITE_CAL_BASE_URL`                                                                                                                                                                      | Cal.com public profile URL. When set, standard event URLs are derived from this base                                       |
| `VITE_CAL_DISCOVERY_CALL_URL` / `VITE_CAL_COACHING_SESSION_URL` / `VITE_CAL_DEEP_DIVE_URL` / `VITE_CAL_PACKAGE_URL` / `VITE_CAL_EVENT_PREP_URL` / `VITE_CAL_EVENT_COMPANION_INQUIRY_URL` | Service-specific Cal.com booking links. Empty -> inquiry form fallback                                                     |
| `VITE_CALENDLY_*`                                                                                                                                                                        | Legacy fallback booking links. Remove after Cal.com links are tested live                                                  |
